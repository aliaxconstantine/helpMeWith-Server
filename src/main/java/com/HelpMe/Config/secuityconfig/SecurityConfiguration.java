package com.HelpMe.Config.secuityconfig;
import com.HelpMe.Config.secuityconfig.secuityEvent.CAuthenticationFailureHandler;
import com.HelpMe.Config.secuityconfig.secuityEvent.CAuthenticationSuccessHandler;
import com.HelpMe.Service.impl.Security.UserServiceImpl;
import com.HelpMe.Config.secuityconfig.secuityfliter.*;
...
public class SecurityConfiguration {
    ...
    public WebSecurityCustomizer webSecurityCustomizer(){
        return (web -> web.ignoring().requestMatchers(SystemConstants.publicUrls));
    }
}
