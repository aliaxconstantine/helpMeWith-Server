...
import com.HelpMe.Service.impl.core.TUserServiceImpl;
...
public class UserController {
    ...
    @Autowired
    public UserController(TUserServiceImpl userService, TasksService tasksService, FriendService friendService, SysUserService sysUserService, TUserInfoService tUserInfoService, CommunicationsService communicationsService) {
    ...
    // 修改用户资料
    @PostMapping("/update")
    public HttpResult updateUser(@RequestBody UserForm userFrom){
